...
public class Application1 {
    public static void main(String[] args) {
        ...
        /**/
        /*상황에 따라 기본 자료형의 데이터를 인스턴스화 해야 하는 경우가 발생한다*/
        /*이 때, 기본 자료형의 데이터를 먼저 인스턴스로 변환 후 사용해야하는데*/
        /*8가지의 해당하는 기본타입의 데이터를 인스턴스화 할 수 있도록 하는 클래스를 래퍼클래스라고 한다*/
        /*(주방에서 사용하는 랩(Wrap) 처럼 감싼다는 뜻)*/
        ...
        /*기본 타입을 래퍼클래스의 인스턴스로 인스턴스화하는 것을 박싱이라고 하며*/
        /*래퍼클래스 타입의 인스턴스를 기본타입으로 변경하는 것을 언박싱이라고 한다.*/

        int intValue = 20;
        Integer boxingNum1 = new Integer(intValue); //인스턴스화 - 박싱 //생성자 이용
        Integer boxingNum2 = Integer.valueOf(intValue); //staic method 이용

        int unBoxingNum1 = boxingNum1.intValue(); //언박싱 //intValue() method 이용
        ...
        Integer integerNum3 = 20; //autoUnBoxing
        Integer integerNum4 = 20; //autoUnBoxing
