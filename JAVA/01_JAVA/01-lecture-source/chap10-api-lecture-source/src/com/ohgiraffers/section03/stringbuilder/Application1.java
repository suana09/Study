...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*String : 불변적 특징을 가지고 있다*/
        /*      문자열에 + 연산을 합치기하는 경우, 기존 인스턴스를 수정하는 것이 아닌 새로운 인스턴스를 반환한다*/
        /*      따라서, 문자열 변경이 자주 일어나는 경우 성능면에서 좋지 않다.*/
        /*      하지만 변하지 않는 문자열을 자주 읽어들이는 경우에는 오히려 좋은 성능을 기대할 수 있다.*/
        /*StringBuilder: 가변적 특정을 가지고 있다.*/
        ...
        System.out.println("sb2.hashCode() = " + sb2.hashCode()); //1480010240

        sb.append("oracle");

        System.out.println("sb = " + sb); //javaoracle

        System.out.println("오라클 붙여준 후 sb.hashCode() = " + sb.hashCode());
        //동일한 인스턴스에 문자열을 + 연산해주었을 때 해시코드가 같음
