...
public class Application1 {
    public static void main(String[] args) {
         ...
         *     윤초는 사소해 보이지만 실제 2012년 링크드인 과 같은 대규모 서비스의 서버를 마비시킨 버그를 발생한 적도 있다.
        ...
        /*1. 기본생성자 사용하는 방법*/
        /*기본 생성자로 인스턴스를 생성하면 운영체제의 날짜/시간 정보를 이용하여 인스턴스를 만들어준다*/
        Date today = new Date(); //import java.util.Date;

        System.out.println("today = " + today);

        /*2. Data(long date) 사용하는 방법*/
        /*getTime(): 1970년 1월 1일 0시 0분 0초를 지난 시간을 millisecond로 계산해서 long 타입으로 반환한다.*/
        System.out.println("today.getTime() = " + today.getTime()); //1712127102484

        Date time = new Date(1712127102484L);
