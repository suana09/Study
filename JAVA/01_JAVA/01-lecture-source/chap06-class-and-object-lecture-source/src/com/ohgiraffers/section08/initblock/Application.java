...
public class Application {
    public static void main(String[] args) {
        ...
        /*3. 인스턴스 초기화 블럭으로 필드 초기화 확인*/
        System.out.println("product.getInformation() = " + product.getInformation());
        
        /*4. 매개변수 있는 생성자를 이용한 초기화 확인*/
        Product p = new Product("대륙폰", 300000, "샤우미");
        System.out.println("p.getInformation() = " + p.getInformation());

        /*여기서 알 수 있는 초기화 순서는*/
        /*인스턴스 변수: 기본값 > 명시적 초기화한 값 > 인스턴스 초기화 블럭 > 생성자*/
        /*클래스 변수: 기본값 > 명시적 초기화한 값 > 정적 초기화 블럭 > 인스턴스 초기화 블럭 > 생성자  */
        /**/
