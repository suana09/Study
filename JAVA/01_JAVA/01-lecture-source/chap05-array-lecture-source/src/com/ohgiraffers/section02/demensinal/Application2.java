...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*자료형[][] 변수명 = new 자료형[할당할 배열의 갯수][할당할 배열의 갯수]*/

        int[][] iarr = new int[3][5]; //길이 5의 배열을 3개 할당하고 그 주소를 묶어 관리하는 배열 stack의 iarr에 저장한다.
        ...
        for(int i=0;i< iarr.length;i++){
            for (int j=0;j<iarr[i].length;j++){
                iarr[i][j] = value++; //배열 i,j + 값 대입
                System.out.print(iarr[i][j] + " "); //출력
            }
            System.out.println();
        }
