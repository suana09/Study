...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*heap 에 공간을 할당할 때는 new연산자를 이용한다*/
        /*배열의 주소를 관리하는 배열의 길이는 앞부분에 정수형으로 표기하여 반드시 크기를 지정해주어야 한다.*/

        //iarr = new int[][]; //크기를 지정하지 않았기 때문에 에러발생
        ...
        iarr[1] = new int[5];
        iarr[2] = new int[5];
        //iarr = new int[3][5]; 이렇게 한번에 묶어서도 가능, 이런 경우를 정변배열이라고 함
