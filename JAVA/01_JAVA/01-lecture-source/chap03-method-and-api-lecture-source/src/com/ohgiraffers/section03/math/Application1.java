...
public class Application1 {
    public static void main(String[] args) {
        /*수업목표 Math 클래스에서 제공하는 static method를 호출할 수 있다.*/
        /*API란?*/
        /*Application Programming Interface, 응용프로그램에서 사용할 수 있도록*/
        /*운영체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 있도록 만든 인터페이스를 뜻한다.*/
        /*쉽게 말해 API는, 우리가 구현할 수 없거나 구현하기 번거로운 기능들을 JDK만 설치하면 사용할 수 있도록*/
        /*JAVA에서 준비해 둔 소스코드 (클래스나 인터페이스) 등을 의미한다.*/

        /*java.lang.Math*/
        /*Math 클래스는 수학에서 자주 사용하는 상수들과 함수들을 미리 구현해놓은 클래스이다.*/
        /*모든 메소드는 static method로 작성되어 있다.*/
        /*(객체의 상태를 관리하지 않고 기능만을 제공하는 경우 메모리를 효율적으로 사용하기 위해 자주 사용되는 기법이다.)*/

        /*1. 절대값 출력*/
        /*1-1. 클래스의 풀네임을 다 적어서 사용해보기*/
