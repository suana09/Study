...
public class Book_Update {
	...
	public static void main(String[] args) {
		...
		//입력한 도서번호로 도서를 조회하여 대상 도서가 있는지 확인
		...
		else System.out.println("레코드 수정 실패.. ㅠ");
